...
# : 파이썬의 예약어, 첫문자를 항상 대문자로 사용해야 함
bool1 = True
bool2 = False
# bool3 = true # Error
print(type(a))
# : type 이라는 키워드를 사용해 해당 변수의 자료형을 확인하는 파이썬의 내장 함수
# 출력값: <class 'int'> 변수 a의 자료형은 int이다.

# 논리형의 경우 조건문의 리턴 값으로 사용됨
print(1 == 1)
print(2 > 1)
print(2 < 1)

print(bool1 + bool2)  # True + False, 출력값 1
...
print('100%% 확신합니다.')  # 문자열 그 자체의 %를 출력하고 싶은 경우 : %%
...
# f-string 포매팅의 장점
# : 표현식 지원 (문자열 안에서 변수와 +, -의 수식을 함께 사용 가능)
a = 5
b = 3
...
# 문자 위치 알려주기: index()
print(str.index('r')) # 4
# print(str.index('k')) # 존재하지 않을 경우 오류 발생(ValueError)
