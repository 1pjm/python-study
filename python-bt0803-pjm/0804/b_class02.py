...
class Person:
    ...
    def who_am_i(self, name, age, tel, address):
        ...
        # 우항의 name은 매개변수 name
        # who_am_i() 메서드를 호출할 때 전달된 name이 인스턴스의 name이 됨
        self.name = name  # jimin.name = name('jimin')
        self.age = age  # jimin.age = 70
        self.tel = tel
        self.address = address


jimin = Person()
jimin.who_am_i('jimin', 70, '010-1111-2222', '부산시')
# self에 객체 jimin이 들어감
# 입력값('jimin', 70, '010-1111-2222', '부산시')들이 각각 매개변수로 들어감
print(jimin.tel)
print(jimin.address)

junGook = Person()
junGook.who_am_i('junGook', 70, '010-3333-4444', '서울시')
print(junGook.name)
print(junGook.age)
