...
# 2행 2열의 subplot으로 구성된 figure를 작성

# add_subplot(2, 2, 1): 2행 2열의 subplot 중 첫 번째 subplot
# add_subplot(2, 2, 2)
# add_subplot(2, 2, 3)
# add_subplot(2, 2, 4)
...
axes1 = figure.add_subplot(2, 2, 3)
axes1 = figure.add_subplot(2, 2, 4)

# 그래프 출력
plt.show()

# 여러 개의 subplot을 동시에 생성: subplots() 함수 사용
axes = plt.subplots(nrow=3, ncols=3)
plt.show()
